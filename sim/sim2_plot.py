...
sns.heatmap(df_heat, annot=True, cmap="YlGnBu", fmt=".2f", cbar=False, annot_kws={"fontsize":25})
plt.xlabel(r'$\beta$ (noise level)', fontsize=30)
plt.ylabel(r'$\rho$ (simulated segmentation proportion)', fontsize=30)
plt.tight_layout()
plt.show()